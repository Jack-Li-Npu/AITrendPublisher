...
在 AI 代理与工具调用成为焦点的当下，`amantus-ai/vibetunnel` 正通过其创新的“虚拟浏览器”技术，为 AI 交互开辟更真实、可控的沙盒环境。

---

## amantus-ai/vibetunnel (⭐ 3.7k)

# VibeTunnel 🚇 - Turn any browser into your terminal; command agents from the road (vt.sh)

<!-- Generated: 2025-07-28 12:35:00 UTC -->
<p align="center">
  <img src="data/articles/2026-02-02-161645-macOS_App__Recommended_for_Mac/images/0d422bcf594cc0f5.png" alt="VibeTunnel Banner" />
</p>
